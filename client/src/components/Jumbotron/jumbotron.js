          ...
          <MDBJumbotron style={{ padding: 0 }}>
            <MDBCol className="text-white text-center py-5 px-4 my-5" style={{ backgroundImage: `url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg)` }}>
              <MDBCol className="py-5">
                <MDBCardTitle className="h1-responsive pt-3 m-5 font-bold">SKISHOP SKI RENTAL AND BIKE REPAIR</MDBCardTitle>
                <p className="mx-5 mb-5">Colorado's premier fake place to rent skis, boards, boots, and bike repair
                </p>
              </MDBCol>
            </MDBCol>
          </MDBJumbotron>
